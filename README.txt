...
generate random jobs : In the menu you can find a generator taht will create 30 randoms jobs from a presset list
...
After that you can :
	The interface opens, displaying the job database.
